...
class EditItem extends StatelessWidget {
  EditItem(this._cashDeposit, {Key? key}) {
    _controllerName = TextEditingController(text: _cashDeposit['name']);
    _controllerQuantity =
        TextEditingController(text: _cashDeposit['quantity']);

    _reference = FirebaseFirestore.instance
        .collection('proofOfDeposit')
        .doc(_cashDeposit['id']);
  }
