...
import 'package:modernlogintute/adminTabs/parcels_extracted.dart';
import 'package:modernlogintute/userTabs/parcels_received.dart';
import 'package:modernlogintute/adminTabs/parcels_stored.dart';
...
class _AdminTransactionsState extends State<AdminTransactions> {
  ...
  Widget _getBody(current) {
    return current == 0 ? ParcelsStored() : ParcelsExtracted();
  }
