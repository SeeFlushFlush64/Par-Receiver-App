        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              buildDetailsRow("Track #:", trackingNumber, context),
              SizedBox(height: MediaQuery.sizeOf(context).height * 0.006),
              buildDetailsRow("Time Added:", time, context),
              SizedBox(height: MediaQuery.sizeOf(context).height * 0.006),
              buildDetailsRow("Date Received:", date, context),
