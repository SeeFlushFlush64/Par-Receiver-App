...
ReceivedDetails receivedDetailsFromJson(String str) =>
    ReceivedDetails.fromJson(json.decode(str));

String receivedDetailsToJson(ReceivedDetails data) =>
    json.encode(data.toJson());

class ReceivedDetails {
  ...
  factory ReceivedDetails.fromJson(Map<String, dynamic> json) =>
      ReceivedDetails(
